...
public class Generic extends Base {
	...
	public boolean inputText(By by, int value) throws Exception {
	...
	public boolean inputText(By by, double value) throws Exception {
	...
	public boolean selectDropdown(By by, String data) throws Exception {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 15);
			WebElement e1 = wait.until(ExpectedConditions.elementToBeClickable(by));
			if (e1.isDisplayed()) {
